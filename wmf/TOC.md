...
##### [Командлет Test-DscConfiguration поддерживает эталонные конфигурации.](5.0/dsc_testconfiguration.md)
...
#### [Поддержка параллельных версий в PowerShell 5.0 или более поздних версиях](5.0/psget_modulesxsinstall.md)
