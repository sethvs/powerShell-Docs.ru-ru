...
Во-первых, мы определяем две функции настройки HelpSample1 и HelpSample2, каждая из которых включает в себя справку на основе комментариев:
...
Чтобы получить справку для HelpSample1, просто выполните следующее:
...
Можно также получить подробную справку, используя Get-Help:
