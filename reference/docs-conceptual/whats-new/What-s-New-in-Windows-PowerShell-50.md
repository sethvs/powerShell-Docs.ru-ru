...
-   [Обновления для DSC Windows PowerShell 4.0 в статье базы знаний 3000850]()

-   [Новые возможности в Windows PowerShell 5.0]()

-   [Новые возможности в Windows PowerShell 4.0]()

-   [Новые возможности в Windows PowerShell 3.0]()
...
Рабочие процессы Windows PowerShell® предоставляют возможности Windows Workflow Foundation в Windows PowerShell. Рабочие процессы можно записывать на языке XAML или Windows PowerShell и запускать их так же, как командлеты. Командлет [Get-Command](https://technet.microsoft.com/en-us/library/59c6d302-6e8c-48b7-a6f6-f0172df936ad) получает команды рабочих процессов, а [Get-Help](https://technet.microsoft.com/en-us/library/1f46eeb4-49d7-4bec-bb29-395d9b42f54a) получает справку для рабочих процессов.
