...
- <span data-ttu-id="f11e8-132">знак вопроса (?) — соответствует ровно одному символу;</span><span class="sxs-lookup"><span data-stu-id="f11e8-132">Question mark (?) matches exactly one character.</span></span>
