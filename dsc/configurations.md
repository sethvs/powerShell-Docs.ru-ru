...
В данном примере вы указываете имя узла, передавая его как параметр $computerName при [компиляции конфигурации] (# Компиляция конфигурации). По умолчанию используется имя localhost.
