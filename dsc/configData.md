...
Чтобы компилировать конфигурацию с заданными данными конфигурации, их нужно передать в значении параметра **ConfigurationData**.
...
В примерах в этом разделе мы использовали только один дополнительный узел и назвали его `NonNodeData`. Однако вы можете определить любое количество дополнительных ключей и назвать их как угодно.
