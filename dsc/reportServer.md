...
## <a name="viewing-report-data"></a><span data-ttu-id="4ceb0-126">Просмотр данных из отчетов</span><span class="sxs-lookup"><span data-stu-id="4ceb0-126">Viewing report data</span></span>
