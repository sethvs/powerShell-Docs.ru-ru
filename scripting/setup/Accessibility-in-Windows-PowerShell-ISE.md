...
## <a name="a-namebkmk1ahow-to-change-the-size-and-location-of-the-console-and-script-panes"></a><a name="bkmk_1"></a> Изменение размера и расположения областей консоли и сценариев
...
## <a name="a-namebkmk2akeyboard-shortcuts-for-editing-text"></a><a name="bkmk_2"></a> Сочетания клавиш для редактирования текста
...
## <a name="a-namebkmk3akeyboard-shortcuts-for-running-scripts"></a><a name="bkmk_3"></a> Сочетания клавиш для выполнения сценариев
...
## <a name="a-namebkmk4akeyboard-shortcuts-for-customizing-the-view"></a><a name="bkmk_4"></a> Сочетания клавиш для настройки представления
...
## <a name="a-namebkmk5akeyboard-shortcuts-for-debugging-scripts"></a><a name="bkmk_5"></a> Сочетания клавиш для отладки сценариев
...
## <a name="a-namebkmk6akeyboard-shortcuts-for-windows-powershell-tabs"></a><a name="bkmk_6"></a> Сочетания клавиш для вкладок сценариев Windows PowerShell
...
## <a name="a-namebkmk7akeyboard-shortcuts-for-starting-and-exiting"></a><a name="bkmk_7"></a> Сочетания клавиш для запуска и выхода
