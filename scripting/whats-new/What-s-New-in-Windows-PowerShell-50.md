...
-   [Новые возможности для настройки требуемого состояния Windows PowerShell](#BKMK_newDSC)

-   [Новые возможности в интегрированной среде скриптов Windows PowerShell](#BKMK_newISE)
...
### <a name="a-namebkmknewiseanew-features-in-windows-powershell-ise"></a><a name="BKMK_newISE"></a> Новые функции в интегрированной среде сценариев Windows PowerShell
...
### <a name="a-namebkmknewodataanew-features-in-windows-powershell-web-services-management-odata-iis-extension"></a><a name="BKMK_newOData"></a> Новая функция в веб-службах Windows PowerShell (расширение IIS OData для управления)
...
-   [Новые возможности в рабочих процессах Windows PowerShell](#BKMK_workflow)

-   [Новые возможности в веб-службах Windows PowerShell](#BKMK_psws)
...
### <a name="a-namebkmkiseanew-features-in-windows-powershell-integrated-scripting-environment-ise"></a><a name="BKMK_ise"></a> Новые функции в интегрированной среде сценариев Windows PowerShell
...
### <a name="a-namebkmkworkflowanew-features-in-windows-powershell-workflow"></a><a name="BKMK_workflow"></a> Новые функции в рабочем процессе Windows PowerShell
...
### <a name="a-namebkmkpswsanew-features-in-windows-powershell-web-services"></a><a name="BKMK_psws"></a> Новые функции в веб-службах Windows PowerShell
...
### <a name="a-namebkmkpowwaanew-features-in-windows-powershell-web-access"></a><a name="BKMK_powwa"></a> Новые функции в Windows PowerShell Web Access
...
-   [Надежная связь для сеансов](#BKMK_Robust)

-   [Система обновляемой справки](#BKMK_UpHelp)

-   [Усовершенствованная справка в Интернете](#BKMK_Online)

-   [Интеграция с CIM](#BKMK_CIM)

-   [Файлы конфигурации сеанса](#BKMK_ConfigFile)

-   [Интеграция запланированных заданий и планировщика задач](#BKMK_ScheduledJob)

-   [Усовершенствования в языке Windows PowerShell](#BKMK_Lang)

-   [Новые основные командлеты](#BKMK_Core)

-   [Усовершенствования в существующих основных командлетах и поставщиках](#BKMK_Prov)

-   [Удаленный импорт и обнаружение модулей](#BKMK_REM)

-   [Усовершенствованное завершение нажатием клавиши TAB](#BKMK_TAB)

-   [Автоматическая загрузка модулей](#BKMK_AutoLoad)
...
-   [Усовершенствования, связанные с форматированием и выходными данными](#BKMK_OUT)

-   [Усовершенствованное взаимодействие с узлом консоли](#BKMK_HOST)

-   [Новые API-интерфейсы командлетов и размещения](#BKMK_API)

-   [Повышение производительности](#BKMK_PERF)

-   [Поддержка запуска от имени и общего узла](#BKMK_RUNAS)

-   [Улучшения в обработке специальных символов](#BKMK_CHAR)

### <a name="a-namebkmkworkflowawindows-powershell-workflow"></a><a name="BKMK_Workflow"></a> Рабочий процесс Windows PowerShell
...
-   **Автоматизация последовательных и длительных задач.**
...
### <a name="a-namebkmkrobustarobust-session-connectivity"></a><a name="BKMK_Robust"></a> Надежное подключение сеансов
...
### <a name="a-namebkmkuphelpaupdatable-help-system"></a><a name="BKMK_UpHelp"></a> Система обновляемой справки
...
### <a name="a-namebkmkonlineaenhanced-online-help"></a><a name="BKMK_Online"></a> Усовершенствованная справка в Интернете
...
### <a name="a-namebkmkscheduledjobascheduled-jobs-and-task-scheduler-integration"></a><a name="BKMK_ScheduledJob"></a> Интеграция запланированных заданий и планировщика задач
...
### <a name="a-namebkmkprovaimprovements-to-existing-core-cmdlets-and-providers"></a><a name="BKMK_Prov"></a> Усовершенствования существующих основных командлетов и поставщиков
...
### <a name="a-namebkmktabaenhanced-tab-completion"></a><a name="BKMK_TAB"></a> Усовершенствованное заполнение нажатием клавиши TAB
...
### <a name="a-namebkmkautoloadamodule-auto-loading"></a><a name="BKMK_AutoLoad"></a>Автоматическая загрузка модулей
...
### <a name="a-namebkmkmodamodule-experience-improvements"></a><a name="BKMK_MOD"></a> Улучшение работы с модулями
...
### <a name="a-namebkmkapianew-cmdlet-and-hosting-apis"></a><a name="BKMK_API"></a> Новые API командлетов и размещения
