...
-   [Создание и выполнение скриптов](#bkmk_1)

-   [Написание и редактирование текста в области скриптов](#bkmk_2)
...
## <a name="a-namebkmk2ahow-to-write-and-edit-text-in-the-script-pane"></a><a name="bkmk_2"></a> Написание и редактирование текста в области сценариев
...
## <a name="a-namebkmk3ahow-to-save-a-script"></a><a name="bkmk_3"></a> Сохранение сценария
