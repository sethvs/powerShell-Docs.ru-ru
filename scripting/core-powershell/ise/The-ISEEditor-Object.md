 ...
 **Возвращает**
 длину строки для строки по указанному номеру.
 ...
 **startLine** — целое число.
 Строка, в которой начинается выделение.

 **startColumn** — целое число.
 Столбец в пределах начальной строки, в котором начинается выделение.

 **endLine** — целое число.
 Строка, в которой заканчивается выделение.

 **endColumn** — целое число.
 Столбец в пределах конечной строки, в котором заканчивается выделение.
