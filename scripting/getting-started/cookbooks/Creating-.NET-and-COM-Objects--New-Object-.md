...
# <a name="creating-net-and-com-objects-newobject"></a>Создание объектов .NET и COM (New-Object)
...
### <a name="using-newobject-for-event-log-access"></a>Использование командлета New-Object для доступа к журналу событий
...
#### <a name="using-constructors-with-newobject"></a>Использование конструкторов с командлетом New-Object
...
#### <a name="accessing-a-remote-event-log-with-newobject"></a>Доступ к удаленному журналу событий с помощью New-Object
...
### <a name="creating-com-objects-with-newobject"></a>Создание COM-объектов с помощью New-Object
...
### <a name="getting-warnings-about-net-frameworkwrapped-com-objects"></a>Получение предупреждений о вызываемых COM-объектах .NET Framework
