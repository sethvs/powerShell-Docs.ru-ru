...
Выполните следующие действия, чтобы открыть или закрыть вкладку в [!INCLUDE[wps_2](../Token/wps_2_md.md)]. Чтобы переименовать вкладку, задайте свойство [DisplayName](https://technet.microsoft.com/en-us/library/a9b58556-951b-4f48-b3ae-b351b7564360#Displayname) для объекта сценария на вкладке [!INCLUDE[wps_2](../Token/wps_2_md.md)].
