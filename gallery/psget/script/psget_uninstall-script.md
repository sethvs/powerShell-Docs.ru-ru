...
---
# <a name="uninstall-script"></a><span data-ttu-id="da836-103">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="da836-103">Uninstall-Script</span></span>

<span data-ttu-id="da836-104">Удаляет файл сценария, который был установлен с помощью PowerShellGet.</span><span class="sxs-lookup"><span data-stu-id="da836-104">Uninstalls a script file which was installed using PowerShellGet.</span></span>

## <a name="description"></a><span data-ttu-id="da836-105">Описание</span><span class="sxs-lookup"><span data-stu-id="da836-105">Description</span></span>

<span data-ttu-id="da836-106">Командлет Uninstall-Script удаляет указанные файлы сценариев, которые были установлены в сетевом репозитории.</span><span class="sxs-lookup"><span data-stu-id="da836-106">The Uninstall-Script cmdlet uninstalls the specified script files which were installed from the online repository.</span></span>

## <a name="cmdlet-syntax"></a><span data-ttu-id="da836-107">Синтаксис командлета</span><span class="sxs-lookup"><span data-stu-id="da836-107">Cmdlet syntax</span></span>

```powershell
Get-Command -Name Uninstall-Script -Module PowerShellGet -Syntax
```
## <a name="cmdlet-online-help-reference"></a><span data-ttu-id="da836-108">Ссылка на раздел справки по командлету в Интернете</span><span class="sxs-lookup"><span data-stu-id="da836-108">Cmdlet online help reference</span></span>

[<span data-ttu-id="da836-109">Uninstall-Script</span><span class="sxs-lookup"><span data-stu-id="da836-109">Uninstall-Script</span></span>](http://go.microsoft.com/fwlink/?LinkId=619789)

## <a name="example-commands"></a><span data-ttu-id="da836-110">Примеры команд</span><span class="sxs-lookup"><span data-stu-id="da836-110">Example commands</span></span>
