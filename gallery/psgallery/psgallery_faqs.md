...
- [Не создавайте сценарии, создавайте модули PowerShell](http://blogs.technet.com/b/heyscriptingguy/archive/2011/06/27/don-t-write-scripts-write-powershell-modules.aspx)
...
## Получена ошибка "Не удалось обработать запрос. "Указанный ключ API является недопустимым или не имеет разрешения на доступ к указанному пакету". Удаленный сервер вернул ошибку: (403) запрещено." при попытке опубликовать элемент в коллекции PowerShell. Что это значит?
...
## Почему после установки всех флажков категорий на вкладке "Элементы" я вижу не все элементы коллекции?
...
## Можно ли зарезервировать имена для элементов, которые будут опубликованы в будущем?
...
## Как запросить право собственности для элементов?

Подробные сведения см. в разделе [Управление владельцами элементов на PowerShellGallery.com](Managing-Item-Owners.md).

## Что делать с владельцем элемента, который нарушает лицензию на мой элемент?
